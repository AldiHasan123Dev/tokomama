<x-Layout.layout>
  ...
  @csrf
        <label class="form-control w-full max-w-xs col-start-1">
          ...
          <input type="text" placeholder="Kode Barang" name="kode_objek" class="input input-bordered w-full max-w-xs rounded-md" required />
        </label>
        <label class="form-control w-full max-w-xs col-start-2">
          <div class="label">
            <span class="label-text">Nama <span class="text-red-500">*</span></span>
          </div>
          <input id="nama" type="text" placeholder="Nama Barang" name="nama" class="input input-bordered w-full max-w-xs rounded-md" required />
        </label>
        ...
        <label class="form-control w-full max-w-xs col-start-1">
          ...
          <input type="text" placeholder="10" name="value" class="input input-bordered w-full max-w-xs rounded-md" required />
        </label>
        <label class="form-control w-full max-w-xs col-start-2">
          <div class="label">
            <span class="label-text">Value PPN<span class="text-red-500">*</span></span>
          </div>
          <input type="number" placeholder="11" name="value_ppn" class="input input-bordered w-full max-w-xs rounded-md" required />
        </label>
        ...
        <div class="col-span-3 mt-8 text-center">
          <button type="submit" class="btn text-semibold text-white bg-green-500 w-1/3 mx-auto">Simpan Data Barang</button>
        </div>
      </form>
