                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card shadow-sm border-success" style="background: #e2190a !important;">
                            <div class="card-body">
                                <h5 class="card-title text-success" style="color: #ffffff;">Persediaan Dalam Perjalanan
                                </h5>
                                <p class="card-text fs-4 fw-bold text-success" style="color: #ffffff;">Rp
                                    {{ number_format($perjalanan, 0, ',', '.') }} (Terjurnal HTG Rp
                                    {{ number_format($perjalanan2, 0, ',', '.') }}) , (Belum Terjurnal Rp
                                    {{ number_format($perjalanan1, 0, ',', '.') }})</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card shadow-sm border-teal" style="background: #20c997 !important;">
                            <div class="card-body">
                                ...
                                <p class="card-text fs-4 fw-bold" style="color: #ffffff;">Rp
                                    {{ number_format($jayapura, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @foreach ($hasil1 as $barang)
                    <div class="col-md-2 mb-1">
                        <div class="card shadow-sm border-teal"
                            style="background: #11926b !important; border-radius: 5px;">
                            <div class="card-body">
                                <h5 class="card-title" style="color: #ffffff; font-size: 14px; font-weight: bold;">
                                    Rincian Stock Barang : <span
                                        style="color: #FFD700; font-weight: bold;">{{ $barang['barang'] }}</span>
                                </h5>
                            </div>
                        </div>
                    </div>
